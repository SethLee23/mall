    ...
    <div class="section section-first">
      <div class="block form js-form">
        ...
        <div class="block-item">
          <label>联系电话</label>
          <input type="tel" placeholder="联系电话" name="tel" maxlength="11" v-model.number="tel" />
        </div>
        <div class="block-item">
          <label>选择地区</label>
          <div class="select-group">
            <select class="js-province-selector" v-model="provinceValue">
              ...
              <option :value="p.value" v-for="p in addressList.list" :key="p.value">{{p.label}}</option>
            </select>
            ...
            >
              ...
              <option :value="d.value" v-for="d in districList" :key="d.value">{{d.label}}</option>
            </select>
          </div>
        </div>
        <div class="block-item">
